...
/*      BUG EXERCISE 6 (because I enjoy watching you suffer)
    In the code, there are some unknown number of compilation errors.
    Find the errors, document the errors, then fix the errors.
    (hint: start by fixing the tabs)
*/
...
public class Bug6 {
    ...
    */
    public static void printWinner(int pScore, int cScore) { //both should be ints
        if (pScore > cScore) {
